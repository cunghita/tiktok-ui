...
import { LetterIcon, MessIcon, UploadIcon } from '../../../icons';
        ...
        <header className={cx('wrapper')}>
            <div className={cx('inner')}>
                ...
                <div className={cx('actions')}>
                    {currentUser ? (
                        <>
                            <button className={cx('action-btn', 'uploadbtn')}>
                                <UploadIcon className={cx('action-icon', 'uploadIcon')} />
                                <span>Tải lên</span>
                            </button>
                            <Tippy delay={[0, 200]} content="Tin nhắn" placement="bottom">
                                <button className={cx('action-btn')}>
                                    <MessIcon className={cx('action-icon')} />
                                </button>
                            </Tippy>
                            <Tippy delay={[0, 200]} content="Hộp thư" placement="bottom" className={cx('tippy-2')}>
                                <button className={cx('action-btn')}>
                                    <LetterIcon className={cx('action-icon')} />
                    ...
                    <Menu items={currentUser ? userMenu : MENU_ITEM} onChange={handleMenuChange}>
                        {currentUser ? (
                            <img
                                src="https://p16-sign-va.tiktokcdn.com/tos-useast2a-avt-0068-giso/7ad8dce741a228b1ac7614ca6b40aaee~c5_100x100.jpeg?x-expires=1680710400&x-signature=0efqOEANxgxgyf2CRK33R5l%2B%2BnM%3D"
